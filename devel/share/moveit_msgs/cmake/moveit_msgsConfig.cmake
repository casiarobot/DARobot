...
if("TRUE" STREQUAL "TRUE")
  set(moveit_msgs_SOURCE_PREFIX /home/bot_ws/src/moveit_msgs)
  set(moveit_msgs_DEVEL_PREFIX /home/bot_ws/devel)
  ...
  set(moveit_msgs_INSTALL_PREFIX /home/bot_ws/install)
...
if(NOT "/home/bot_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bot_ws/src/moveit_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/bot_ws/devel/lib;/opt/ros/kinetic/lib)
