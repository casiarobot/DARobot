...
if("TRUE" STREQUAL "TRUE")
  set(openni2_launch_SOURCE_PREFIX /home/bot_ws/src/openni2_camera/openni2_launch)
  set(openni2_launch_DEVEL_PREFIX /home/bot_ws/devel)
  ...
  set(openni2_launch_INSTALL_PREFIX /home/bot_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'openni2_launch' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/bot_ws/src/openni2_camera/openni2_launch/${idir}'.  ${_report}")
    endif()
